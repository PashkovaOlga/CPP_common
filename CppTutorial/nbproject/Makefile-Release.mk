...
${OBJECTDIR}/ClassA/ClassA.o: ClassA/ClassA.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClassA/ClassA.o ClassA/ClassA.cpp

${OBJECTDIR}/ClassB/ClassB.o: ClassB/ClassB.cpp 
	${MKDIR} -p ${OBJECTDIR}/ClassB
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClassB/ClassB.o ClassB/ClassB.cpp

${OBJECTDIR}/GoodClass/GoodClass.o: GoodClass/GoodClass.cpp 
	${MKDIR} -p ${OBJECTDIR}/GoodClass
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GoodClass/GoodClass.o GoodClass/GoodClass.cpp

${OBJECTDIR}/KeyWords/KeyWords.o: KeyWords/KeyWords.cpp 
	${MKDIR} -p ${OBJECTDIR}/KeyWords
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/KeyWords/KeyWords.o KeyWords/KeyWords.cpp
